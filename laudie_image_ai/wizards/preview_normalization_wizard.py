...
class PreviewNormalizationWizard(models.TransientModel):
    _name = 'laudie.preview.normalization.wizard'
    ...
    def default_get(self, fields_list):
        ...
        cfg = self.env['res.config.settings'].sudo().get_laudie_config()
        res.update({
    ...
    def action_save_as_defaults(self):
        ...
        param.set_param('laudie_image_ai.laudie_target_canvas_size', str(self.target_canvas_size))
        param.set_param('laudie_image_ai.laudie_padding_percent', str(self.padding_percent))
        param.set_param('laudie_image_ai.laudie_bg_color', self.bg_color)
        param.set_param('laudie_image_ai.laudie_jpeg_quality', str(self.jpeg_quality))
        param.set_param('laudie_image_ai.laudie_output_format', self.output_format)
        param.set_param('laudie_image_ai.laudie_white_threshold', str(self.white_threshold))
        param.set_param('laudie_image_ai.laudie_white_bg_min_percent', str(self.white_bg_min_percent))
        return {
